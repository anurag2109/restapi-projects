    ...
    <div className="slideContainer">
      ...
      >
        {series.map((webseries) => (
          <Link
            to={`/webseries/${webseries.webSeriesId}`}
            style={{ textDecoration: "none" }}
            key={webseries.webSeriesId}
          >
            <div className="sliderImgAndTextBox">
              ...
              >
                ...
                >
                  <p>{webseries.genre}, &nbsp;</p>
                  <p>{webseries.languages}, &nbsp;</p>
                  <p>{webseries.director}, &nbsp;</p>
                  <p>
                    <span>{webseries.actors}, &nbsp;</span>
                    <span>episodes</span>{" "}
                  </p>
                </div>
              </div>
